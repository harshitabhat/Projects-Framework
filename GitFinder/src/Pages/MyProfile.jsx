...
const MyProfile = () => {
  ...
  useEffect(() => {
    const apiCall = setTimeout(() => {
      axios.get("https://api.github.com/users/harshitabhat").then((res) => setData(res.data));
      axios.get("https://api.github.com/users/harshitabhat/repos").then((res) => setRepos(res.data));
    }, 1500);
