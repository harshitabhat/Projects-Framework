...
const Header = () => {
  ...
  return (
    <header className={`flex justify-between ${theme === "dark" ? "bg-orange-800" : "bg-red-900"} items-center p-5 px-4 md:px-40`}>
      {/* Logo */}
      ...
      <nav className="hidden md:flex md:items-center ">
        <ul className="flex text-sm md:text-xl">
          <li className="mx-3 border-b-2 border-white/[0] hover:border-white/[100] ">
            <NavLink to="/" className={(navData) => navData.isActive ? "text-emerald-200" : ""}>
              Home
            </NavLink>
          </li>
          <li className="mx-3 border-b-2 border-white/[0] hover:border-white/[100] ">
